...
const STATUS_ICONS: Record<string, { icon: Icon; color: string; bg: string; gradient: string; border: string }> = {
...
const CARDS = [
  {
    ...
    description: "Powered by IBM's Granite language model via Ollama. Completely offline, with no cloud dependency. Ask anything about space and astronomy.",
    visual: <Card1 />,
  ...
  },
  {
    ...
    description: "LangChain and ChromaDB index NASA articles, astronomy books, and research papers to deliver accurate, grounded answers.",
    visual: <Card4 />,
    colSpan: "lg:col-span-1",
    height: "h-[260px]",
  },
  {
    ...
    description: "An interactive solar system with real planet imagery, animated orbital movement, and carefully balanced planetary scale.",
    visual: <Card2 />,
    colSpan: "lg:col-span-1",
    height: "h-[260px]",
  },
  {
    ...
    description: "Select any planet for scientific data covering its atmosphere, gravity, temperature, moons, and AI-powered explanations.",
    visual: <Card3 />,
    colSpan: "lg:col-span-1",
    height: "h-[260px]",
  },
  {
    ...
    description: "Explore space missions, trajectory planning, habitability analysis, and future exploration concepts with Granite AI.",
    visual: <Card5 />,
    colSpan: "lg:col-span-1",
    height: "h-[260px]",
  },
  {
    title: "Real-time Q&A",
    description: "Conversational memory enables multi-turn dialogue, contextual planet questions, space quizzes, and astronomical explanations.",
    visual: <Card3 />,
    colSpan: "lg:col-span-1",
    height: "h-[260px]",
  }
